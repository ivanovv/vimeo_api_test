...
Приложение, которое мы хотим увидеть, должно представлять собой список
...
удалять. Добавлять можно по id (простой вариант) или сделать интерфейс
поиска интересных роликов (bonus points).
